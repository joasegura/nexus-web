import { ArrowRight, BarChart3, CheckCircle2, Clock, FileText, Package, Shield, Truck, Users, Warehouse, Zap } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl mb-8 text-blue-100">
                Imagina un futuro donde la administración de tu empresa es más
                eficiente, ordenada y sin imprevistos.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              La solución más completa para tu empresa de logística
            </h2>
            <p className="text-gray-600 text-lg">
              Nexus te ofrece todas las herramientas necesarias para optimizar
              tus operaciones y maximizar la eficiencia de tu flota.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <BenefitItem
                icon={CheckCircle2}
                title="Control total de tu flota en tiempo real"
              />
              <BenefitItem
                icon={Shield}
                title="Máxima seguridad y protección de datos"
              />
              <BenefitItem
                icon={Clock}
                title="Ahorro significativo de tiempo en gestiones"
              />
              <BenefitItem
                icon={Zap}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-gray-600 mb-4">
                "Nexus ha transformado completamente la manera en que
                gestionamos nuestra flota. La eficiencia ha aumentado
                significativamente."
              </p>
              <div className="font-semibold">Carlos Rodríguez</div>
              <div className="text-gray-500">
                Director de Operaciones, TransCargo
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-gray-600 mb-4">
                "El control y seguimiento que nos brinda la plataforma es
                excepcional. Ha sido una inversión que realmente vale la pena."
              </p>
              <div className="font-semibold">Ana Martínez</div>
              <div className="text-gray-500">
                Gerente de Logística, LogisTech
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <p className="text-gray-600 mb-4">
                "La implementación fue muy sencilla y el soporte técnico es
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">
            ¡OPTIMIZA TU EMPRESA HOY MISMO!
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Únete a más de 500 empresas que ya han transformado su gestión
            logística con Nexus.
          </p>
          <div className="flex gap-4 justify-center">
